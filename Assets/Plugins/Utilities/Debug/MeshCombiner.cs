...
namespace tdk.Utilities
{
	...
	public class MeshCombiner : MonoBehaviour
	{
		...
		[SerializeField]
		bool createMultiMaterialMesh = false, combineInactiveChildren = false, deactivateCombinedChildren = true,
		...
		/// <summary>
		/// Fills or creates a MeshCollider with the current mesh.
		/// </summary>
		private void AttachMeshToCollider(Mesh mesh)
		{
			#region Attach Collider
		...
		private void CombineMeshesWithSingleMaterial(bool showCreatedMeshInfo)
		{
			...
			AttachMeshToCollider(combinedMesh);
